...
class ClientMessagesController extends GetxController {
  final String currentUserId;

  ClientMessagesController({required this.currentUserId});
  ...
  void onInit() {
    super.onInit();
    debugPrint("==================================================");
    debugPrint("💬 CLIENT MESSAGES CONTROLLER INIT");
  ...
  void onClose() {
    debugPrint("==================================================");
    debugPrint("🧹 CLIENT MESSAGES CONTROLLER CLOSE");
    debugPrint("➡️ CURRENT USER ID => $currentUserId");
    debugPrint("==================================================");
    messageCtrl.dispose();
    super.onClose();
  ...
  Future<void> connectSocket() async {
    try {
      debugPrint("==================================================");
      debugPrint("🔌 CONNECT SOCKET CALLED");
      debugPrint("➡️ ROLE => client");
      ...
      debugPrint("✅ SOCKET CONNECT REQUEST DONE");
    } catch (e) {
  ...
  void attachGlobalListeners() {
    ...
    debugPrint("==================================================");
    debugPrint("🎧 ATTACH GLOBAL SOCKET LISTENERS");
    ...
    debugPrint("✅ GLOBAL SOCKET LISTENERS ATTACHED");
  }

  Future<void> initForProposal(String proposalId) async {
    debugPrint("==================================================");
    debugPrint("🚀 INIT FOR PROPOSAL");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("==================================================");
    ...
    debugPrint("✅ INIT FOR PROPOSAL COMPLETE => $proposalId");
  }

  void joinProposalRoom(String proposalId) {
    debugPrint("==================================================");
    debugPrint("🏠 JOIN PROPOSAL ROOM");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("==================================================");
  ...
  Future<void> loadMessages(String proposalId) async {
    try {
      ...
      final list = await ClientMessagesRepo.fetchMessages(proposalId);
      ...
      debugPrint("✅ LOCAL CHAT UPDATED");
      debugPrint("➡️ TOTAL LOCAL MESSAGES => ${chats[proposalId]?.length ?? 0}");
  ...
  Future<void> sendMessage(String proposalId) async {
    ...
    try {
      ...
      final msg = await ClientMessagesRepo.sendMessage(
  ...
  Future<void> markAllIncomingSeen(String proposalId) async {
    debugPrint("==================================================");
    debugPrint("👁 MARK ALL INCOMING SEEN");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("==================================================");

    final list = chats[proposalId] ?? [];

    debugPrint("➡️ TOTAL LOCAL MESSAGES => ${list.length}");
    ...
    debugPrint("✅ MARK ALL INCOMING SEEN COMPLETE");
  }

  Future<void> markSeen(String proposalId, String messageId) async {
    debugPrint("==================================================");
    debugPrint("👁 MARK SEEN CALLED");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("➡️ MESSAGE ID => $messageId");
    debugPrint("==================================================");
    ...
    try {
      final ok = await ClientMessagesRepo.markSeen(messageId);
  ...
  Future<void> deleteMessage(String proposalId, String messageId) async {
    debugPrint("==================================================");
    debugPrint("🗑 DELETE MESSAGE CALLED");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("➡️ MESSAGE ID => $messageId");
    debugPrint("==================================================");

    try {
      final ok = await ClientMessagesRepo.deleteMessage(messageId);
  ...
  void addMessageSocket(String proposalId, MessageModel msg) {
    ...
    debugPrint("➡️ TOTAL MESSAGES AFTER INSERT => ${chats[proposalId]?.length ?? 0}");
  ...
  void markSeenSocket(String proposalId, String messageId) {
    debugPrint("==================================================");
    debugPrint("✅ MARK SEEN SOCKET UPDATE");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("➡️ MESSAGE ID => $messageId");
    debugPrint("==================================================");
    ...
    debugPrint("✅ MESSAGE MARKED AS READ LOCALLY");
  ...
  void deleteMessageSocket(String proposalId, String messageId) {
    debugPrint("==================================================");
    debugPrint("🗑 DELETE MESSAGE SOCKET UPDATE");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("➡️ MESSAGE ID => $messageId");
    debugPrint("==================================================");
  ...
  void _refreshUnreadForProposal(String proposalId) {
    ...
    debugPrint("==================================================");
    debugPrint("🔄 REFRESH UNREAD COUNT");
    debugPrint("➡️ PROPOSAL ID => $proposalId");
    debugPrint("➡️ CURRENT USER ID => $currentUserId");
  ...
  int unreadCountForProposal(String proposalId) {
    ...
    debugPrint("📌 UNREAD COUNT FOR PROPOSAL => $proposalId : $count");
  ...
  List<MessageModel> messagesOf(String proposalId) {
    ...
    debugPrint("📌 MESSAGES OF PROPOSAL => $proposalId : ${list.length}");
