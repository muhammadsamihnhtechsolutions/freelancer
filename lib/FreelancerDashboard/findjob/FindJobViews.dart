...
//                 print("📦 JOB COUNT → ${controller.filteredJobs.length}");
...
//   /// CATEGORY
//   Widget _buildCategoryDropdown(JobsController controller) {
